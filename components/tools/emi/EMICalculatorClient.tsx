...
export default function EMICalculatorClient() {
  ...
  useEffect(() => {
    ...
    const calculate = async () => {
      setIsLoading(true);
      try {
        const res = await workerManager.calculateEmiSchedule(inputs);
  ...
  return (
    <ToolShell
      ...
      description="Plan your loans with precision. Simulate prepayments, check affordability, compare scenarios, and export full amortization schedules."
      category={cat}
    ...
    >
      <div className="space-y-12">
        ...
        <div className="hidden print-only py-10 border-b-2 border-border mb-10">
           <h1 className="text-4xl font-black">KaruviLab EMI Report</h1>
