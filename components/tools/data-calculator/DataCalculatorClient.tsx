...
export default function DataCalculatorClient() {
  ...
  return (
    <ToolShell
      ...
      description="The ultimate utility suite for data professionals. Convert units, estimate transfer times, plan storage costs, and generate secure checksums locally."
      category={cat}
