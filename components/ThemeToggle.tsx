...
export function ThemeToggle() {
  ...
  return (
    <m.button
      ...
      onClick={toggleTheme}
      className="w-11 h-11 md:w-10 md:h-10 flex items-center justify-center rounded-xl bg-surface border border-border hover:border-blue/30 hover:text-blue transition-colors group relative overflow-hidden flex-shrink-0"
