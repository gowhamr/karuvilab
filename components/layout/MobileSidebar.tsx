  ...
  return (
    <div className="md:hidden">
      ...
      <m.aside
        ...
        className={cn(
          "fixed top-0 left-0 bottom-0 w-[280px] bg-mat-surface border-r border-mat-border shadow-mat-shine z-[100] rounded-r-[32px] flex flex-col touch-none overflow-hidden outline-none"
        )}
      >
