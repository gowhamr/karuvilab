    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="space-y-1">
          ...
          {errorCode && (
            <span className="inline-block mt-2 px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/5 text-[8px] font-mono font-black uppercase tracking-tighter opacity-50">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
        {retryAction && (
          <button
            onClick={retryAction}
            className="flex items-center justify-center gap-2 px-6 py-2.5 bg-blue text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:opacity-90 active:scale-95 transition-all shadow-md shadow-blue/10"
          >
        ...
        {changeFileAction && (
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-2.5 bg-surface border border-border text-text-2 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:border-blue/50 transition-all active:scale-95 shadow-sm"
          >
