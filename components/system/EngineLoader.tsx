    ...
    <AnimatePresence mode="wait">
      {hasError ? (
        ...
        >
          ...
          <button
            onClick={handleRetry}
            className="flex items-center gap-2 px-6 py-2.5 bg-error text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:opacity-90 transition-all mx-auto active:scale-95 shadow-md shadow-error/10"
          >
