      ...
      <button 
        ...
        className={cn(
          ...
          isHero 
            ...
            : "p-3 sm:px-4 sm:py-2 rounded-2xl h-11 w-full md:min-w-60 lg:min-w-80 text-sm font-medium hover:border-brand-primary/30 hover:bg-mat-hover",
          className
        )}
      >
        ...
        <div className={cn(
          ...
          isHero ? "text-xs font-mono font-black" : "text-xs font-mono font-bold"
        )}>
