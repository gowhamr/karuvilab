...
export function FocusModeWrapper({
  ...
  const { isFullscreen, enter, activeToolId, registerTool, unregisterTool } = useFullscreenContext();
        ...
        <div className="relative group/focus">
          <button
            ...
            className={`
              ...
              bg-mat-raised/80 backdrop-blur-sm
