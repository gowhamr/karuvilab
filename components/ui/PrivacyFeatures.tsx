  ...
  return (
    <div className="space-y-12">
        ...
        {FEATURES.map((f, i) => (
          ...
          >
            ...
            <div className="relative z-10 space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-blue/5 border border-blue/10 flex items-center justify-center text-blue group-hover:bg-blue group-hover:text-text transition-all duration-500">
      ...
      <m.div 
        ...
        viewport={{ once: true }}
        className="bg-gradient-to-br from-blue to-blue-dark rounded-[40px] p-8 md:p-12 text-text flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl shadow-blue/20"
      >
        <div className="space-y-4 text-center md:text-left">
          ...
          <p className="text-blue-light/85 text-lg font-medium max-w-xl">
        ...
        <Link 
          href="/privacy" 
          className="px-8 py-4 bg-mat-surface text-text border border-mat-border rounded-2xl font-black hover:scale-105 transition-transform shadow-xl whitespace-nowrap"
        >
          View Privacy Policy
        </Link>
      </m.div>
