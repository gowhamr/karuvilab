    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {FEATURES.map((f, i) => (
          <m.div
            ...
            className="relative flex items-start gap-4 md:flex-col md:items-start p-4 md:p-8 bg-[--kv-mat-surface] border border-mat-border shadow-sm rounded-[20px] overflow-hidden group hover:border-[--kv-brand-primary]/30 hover:-translate-y-0.5 transition-all duration-300"
          >
      ...
      >
        <div className="space-y-2 text-center md:text-left">
          ...
          <p className="text-white/85 text-sm md:text-base font-medium leading-relaxed max-w-xl">
