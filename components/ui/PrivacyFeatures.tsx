  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <Link 
          href="/privacy" 
          className="w-full md:w-auto h-13 px-8 bg-white text-surface rounded-xl font-bold text-base hover:bg-white/90 transition-opacity flex items-center justify-center whitespace-nowrap shadow-md"
        >
          View Privacy Policy
        </Link>
      </m.div>
