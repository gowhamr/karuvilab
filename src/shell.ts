      ...
      header.innerHTML = `
        <div class="ts-brand">
          <a href="${base}" class="ts-logo-link" aria-label="KaruviLab home" style="text-decoration:none">
            <div class="ts-logo" aria-hidden="true" style="background: linear-gradient(180deg, #3B82F6 0%, #1E3A8A 100%); border-radius: 9px; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(30, 64, 175, 0.35);">
              <svg aria-hidden="true" focusable="false" width="20" height="20" viewBox="0 0 24 24" fill="#fff">
                <!-- Stylised K mark with wrench accent -->
                <path d="M5 3h3v18H5z"/>
