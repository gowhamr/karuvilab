        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              <button onClick={() => setInputs({ currentSavings: Math.max(0, inputs.currentSavings - 100000) })} className="px-2.5 py-1 text-[10px] font-bold text-text-4 bg-surface border border-border hover:bg-surface-2 rounded-md transition-colors uppercase tracking-wider">-1L</button>
              <button onClick={() => setInputs({ currentSavings: Math.min(50000000, inputs.currentSavings + 100000) })} className="px-2.5 py-1 text-[10px] font-bold text-blue bg-blue/10 hover:bg-blue/20 rounded-md transition-colors uppercase tracking-wider">+1L</button>
              <button onClick={() => setInputs({ currentSavings: Math.min(50000000, inputs.currentSavings + 500000) })} className="px-2.5 py-1 text-[10px] font-bold text-blue bg-blue/10 hover:bg-blue/20 rounded-md transition-colors uppercase tracking-wider">+5L</button>
              <button onClick={() => setInputs({ currentSavings: Math.min(50000000, inputs.currentSavings + 1000000) })} className="px-2.5 py-1 text-[10px] font-bold text-blue bg-blue/10 hover:bg-blue/20 rounded-md transition-colors uppercase tracking-wider">+10L</button>
              <button onClick={() => setInputs({ currentSavings: Math.min(50000000, inputs.currentSavings + 10000000) })} className="px-2.5 py-1 text-[10px] font-bold text-blue bg-blue/10 hover:bg-blue/20 rounded-md transition-colors uppercase tracking-wider">+1Cr</button>
            </div>
          </div>
