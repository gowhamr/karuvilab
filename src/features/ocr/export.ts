...
import { OcrResult } from './postprocess';

export type OcrExportFormat = 'txt' | 'json' | 'md' | 'csv';

export function exportOcrResult(result: OcrResult, format: OcrExportFormat): string {
  switch (format) {
    case 'txt':
