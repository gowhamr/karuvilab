...
export function StatBar({ stats, goal = 500 }: StatBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 px-4 py-2 bg-bg/50 border-t border-border text-[10px] font-bold text-text-4 uppercase tracking-widest">
      ...
      <div className="flex-1 min-w-[120px] flex items-center gap-2 max-w-xs ml-auto">
        <span className="text-[9px]">Goal ({goal})</span>
