...
export class U2NetPEngine implements RemovalEngine {
  public readonly id = 'u2netp-mobile';
  public readonly name = 'U²-NetP Mobile AI';
  public readonly description = 'Lightweight 4.4 MB offline neural model. Ultra-fast CPU WASM inference for general segmentation.';
  ...
  public async generateMask(
    ...
    try {
      ...
      throw new EngineExecutionError(this.id, (err as Error).message || 'Neural inference failed', err);
    }
  }
}
