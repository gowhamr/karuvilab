...
export const CATEGORIES: CategoryEntry[] = [
  ...
  { id: 'banking',      label: 'Banking Tools',   href: 'banking-tools/',     emoji: '🏦', description: 'Parsers and decoders for EMV, SWIFT, and banking protocol logs.', color: '#059669' },
  { id: 'seo',          label: 'SEO Tools',       href: 'seo-tools/',         emoji: '📈', description: 'Analyze titles, meta tags, and robots configurations to optimize visibility.', color: '#2563EB' }
];
