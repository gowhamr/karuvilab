...
export function ProcessingView({ progress, onCancel }: ProcessingViewProps) {
  return (
    <div className="p-8 md:p-12 bg-mat-surface border border-mat-border shadow-mat-shine rounded-4xl flex flex-col items-center justify-center text-center space-y-8 min-h-80">
