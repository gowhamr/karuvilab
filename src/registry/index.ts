...
import { command_cheat_sheet } from './tools/command-cheat-sheet';
import { hash_map_visualizer } from './tools/hash-map-visualizer';
import { financial_freedom_calculator } from './tools/financial-freedom-calculator';
import { crontab_editor } from './tools/crontab-editor';
import { bmi_calculator } from './tools/bmi-calculator';
import { lorem_ipsum } from './tools/lorem-ipsum';
import { csv_to_json } from './tools/csv-to-json';
import { xml_formatter } from './tools/xml-formatter';
import { uuid_generator } from './tools/uuid-generator';
import { unix_timestamp } from './tools/unix-timestamp';
import { income_tax } from './tools/income-tax';
import { hra_calculator } from './tools/hra-calculator';
import { gratuity_calculator } from './tools/gratuity-calculator';
import { tds_calculator } from './tools/tds-calculator';
import { nps_calculator } from './tools/nps-calculator';

import { gradient_generator } from './tools/gradient-generator';
import { contrast_checker } from './tools/contrast-checker';
import { box_shadow_generator } from './tools/box-shadow-generator';
import { glassmorphism_generator } from './tools/glassmorphism-generator';

import { hmac_generator } from './tools/hmac-generator';
import { cipher_tools } from './tools/cipher-tools';
import { csp_builder } from './tools/csp-builder';

export const ALL_TOOLS: ToolEntry[] = [
  financial_freedom_calculator, emi_calculator, sip_calculator, age_calculator, compound_interest, gst_calculator, currency_converter, discount_calculator, world_clock, date_calculator, time_calculator, standard_calculator, salary_calculator, percentage_calculator, unit_converter, numeral_converter, smart_converter, safe_to_spend, work_hours, utc_ist_converter, mutual_fund_returns, lumpsum_calculator, ppf_calculator, fd_calculator, rd_calculator, cagr_calculator, stock_average_calculator, retirement_calculator, swp_calculator, inflation_calculator, data_calculator, file_viewer_diff, compress_pdf, merge_pdf, split_pdf, image_to_pdf, pdf_to_word, lock_unlock_pdf, watermark_pdf, page_numbering, rotate_pdf, extract_images, image_compress, image_converter, image_resizer, image_crop, bulk_resizer, bg_remover, image_base64, json_formatter, json_csv, regex_tester, code_minifier, diff_checker, format, html_viewer, base64, password_generator, hash_generator, url_encoder, html_entities, jwt_decoder, qrcode, split_copy, text_utility, grammar_checker, task_reminder, markdown, url_cleaner, validate, internet_speed_test, meta_tags, og_preview, sitemap_generator, robots_txt, image_seo, slug_generator, seo_title, calendar, yaml_validator, pomodoro_timer, color_palette_extractor, timezone_converter, fake_data_generator, scientific_calculator, text_sorter_deduper, mic_camera_tester, wifi_qr_code, phone_mockup_generator, chart_generator, typing_speed_test, barcode_scanner, notes, word_counter, text_case_converter, invoice_generator, color_converter, word_to_pdf, video_trim, audio_converter, gif_creator, video_metadata_viewer, command_cheat_sheet, hash_map_visualizer, crontab_editor, bmi_calculator, lorem_ipsum, csv_to_json, xml_formatter, uuid_generator, unix_timestamp, income_tax, hra_calculator, gratuity_calculator, tds_calculator, nps_calculator, gradient_generator, contrast_checker, box_shadow_generator, glassmorphism_generator, hmac_generator, cipher_tools, csp_builder
];