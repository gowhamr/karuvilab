...
export const pdfToWordContent: ToolContent = {
  detailedDescription: "The PDF to Word tool is a secure, browser-native utility designed to help you with your daily tasks. Built with privacy as a core principle, all operations happen locally on your device, ensuring your data never leaves your browser.",
  howTo: [
    "Upload or enter the required data for PDF to Word.",
