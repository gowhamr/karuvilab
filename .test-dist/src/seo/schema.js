 ...
 */
export function generateToolSchema({ name, description, category, path, lastUpdated, features = [], schemaType = "WebApplication", }) {
    const canonicalUrl = getCanonicalUrl(path);
    const getApplicationCategory = (cat) => {
        switch (cat) {
 ...
 */
export function generateCollectionSchema(categoryLabel, description, path) {
    return {
        "@context": "https://schema.org",
        "@type": "CollectionPage",
