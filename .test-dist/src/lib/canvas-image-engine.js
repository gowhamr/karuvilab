...
function canvasToBlob(canvas, format = 'image/png', quality = DEFAULT_QUALITY) {
...
function getAnchorOffset(anchor, outerW, outerH, innerW, innerH) {
    let x = 0;
    let y = 0;
 ...
 */
export function flipImage(img, direction, format = 'image/png', quality = DEFAULT_QUALITY) {
 ...
 */
export function mirrorImage(img, format = 'image/png', quality = DEFAULT_QUALITY) {
 ...
 */
export function resizeCanvas(img, newWidth, newHeight, anchor = 'center', bgColor = 'transparent', format = 'image/png', quality = DEFAULT_QUALITY) {
    const w = img.width || img.naturalWidth;
    const h = img.height || img.naturalHeight;
 ...
 */
export function addPadding(img, padding, bgColor = '#ffffff', format = 'image/png', quality = DEFAULT_QUALITY) {
    const w = img.width || img.naturalWidth;
    const h = img.height || img.naturalHeight;
 ...
 */
export function addBorder(img, border, format = 'image/png', quality = DEFAULT_QUALITY) {
    const w = img.width || img.naturalWidth;
    const h = img.height || img.naturalHeight;
 ...
 */
export function convertAspectRatio(img, targetW, targetH, mode = 'pad', bgColor = '#ffffff', format = 'image/png', quality = DEFAULT_QUALITY) {
    const w = img.width || img.naturalWidth;
    const h = img.height || img.naturalHeight;
 ...
 */
export function rotateImage(img, degrees, bgColor = 'transparent', format = 'image/png', quality = DEFAULT_QUALITY) {
    const w = img.width || img.naturalWidth;
    const h = img.height || img.naturalHeight;
