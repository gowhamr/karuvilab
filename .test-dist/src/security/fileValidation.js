 ...
 */
export function validateExtension(fileName, allowedExtensions) {
 ...
 * Validates file size.
 */
export function validateFileSize(fileSize, maxMB) {
 ...
 */
export async function validateImportedFile(file, allowedExtensions, maxMB) {
    // 1. Validate size
