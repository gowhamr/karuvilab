import { WESTERN_ZODIAC_SIGNS, VEDIC_RASIS, VEDIC_NAKSHATRAS, CHINESE_ZODIAC_ANIMALS, CHINESE_ZODIAC_ELEMENTS, BIRTH_GEMS_AND_FLOWERS, } from './constants';
import { toRad, normDeg, calculateAyanamsa, getUtcDateFromLocal, } from './astronomy-utils';
export function getSunZodiacSign(month, day) {
...
export function getDetailedMoonPosition(dateStr, timeStr = "12:00", tzOffsetMinutes = 0) {
    ...
    let phaseEmoji = "🌑";
    if (normalizedPhase < 1.85) {
        phaseName = "New Moon";
        phaseEmoji = "🌑";
    }
    else if (normalizedPhase < 5.54) {
        phaseName = "Waxing Crescent";
        phaseEmoji = "🌒";
    }
    else if (normalizedPhase < 9.23) {
        phaseName = "First Quarter";
        phaseEmoji = "🌓";
    }
    else if (normalizedPhase < 12.92) {
        phaseName = "Waxing Gibbous";
        phaseEmoji = "🌔";
    }
    else if (normalizedPhase < 16.61) {
        phaseName = "Full Moon";
        phaseEmoji = "🌕";
    }
    else if (normalizedPhase < 20.30) {
        phaseName = "Waning Gibbous";
        phaseEmoji = "🌖";
    }
    else if (normalizedPhase < 23.99) {
        phaseName = "Last Quarter";
        phaseEmoji = "🌗";
    }
    else if (normalizedPhase < 27.68) {
...
export function getBirthstoneAndFlower(month) {
