...
export function calculateFullAgeProfile(dob, asOf, showPrecisionTime = false, birthTime = "12:00", tzOffset = 0) {
    ...
    const moonDetails = getDetailedMoonPosition(dob, showPrecisionTime ? birthTime : "12:00", showPrecisionTime ? tzOffset : 0);
    const ephemeris = calculateEphemeris(dob, showPrecisionTime ? birthTime : "12:00", showPrecisionTime ? tzOffset : 0);
