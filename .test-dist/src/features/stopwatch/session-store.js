...
export const useStopwatchSessionStore = create()(persist((set, get) => ({
    sessions: [],
    ...
    saveSession: (sessionData) => {
        ...
        set((state) => {
            ...
            const updatedRecords = {
                ...
                bestConsistencyScore: sessionData.consistencyScore !== null
