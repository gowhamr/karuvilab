 ...
 */
export function compareStopwatchSessions(sessionA, sessionB) {
    const totalDurationDiffMs = sessionB.totalDurationMs - sessionA.totalDurationMs;
    const totalDurationImprovementPct = sessionA.totalDurationMs > 0
        ? Number((((sessionA.totalDurationMs - sessionB.totalDurationMs) / sessionA.totalDurationMs) * 100).toFixed(2))
        : 0;
    const bestLapDiffMs = sessionA.bestLapMs !== null && sessionB.bestLapMs !== null
        ? sessionB.bestLapMs - sessionA.bestLapMs
        : null;
    const avgLapDiffMs = sessionA.avgLapMs !== null && sessionB.avgLapMs !== null
        ? sessionB.avgLapMs - sessionA.avgLapMs
        : null;
    const consistencyDiff = sessionA.consistencyScore !== null && sessionB.consistencyScore !== null
