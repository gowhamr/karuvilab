 ...
 */
export function exportStopwatchJSON(stats, laps, precision = 'milliseconds') {
    const data = {
        summary: {
 ...
 */
export function exportStopwatchCSV(stats, laps, precision = 'milliseconds') {
    const headers = [
        'Lap Number',
        'Lap Time (Formatted)',
        'Lap Time (ms)',
 ...
 */
export function exportStopwatchText(stats, laps, precision = 'milliseconds') {
    const lines = [];
