...
export class InstantCanvasEngine {
    id = 'instant-canvas';
    name = 'Instant Canvas Removal';
    description = 'Deterministic color distance segmentation. 0 MB download, instant speed for clean solid backgrounds.';
    capabilities = {
    ...
    async generateMask(input, onProgress, abortSignal) {
        ...
        try {
            ...
            throw new EngineExecutionError(this.id, err.message || 'Execution error', err);
        }
    }
}
