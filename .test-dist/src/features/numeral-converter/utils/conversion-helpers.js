...
export const HTML_ENTITIES_MAP = {
    "&lt;": "<", "&gt;": ">", "&amp;": "&", "&quot;": "\"", "&apos;": "'", "&nbsp;": "\u00A0",
...
export function decodeToBytes(input, format) {
    const trimmed = input.trim();
    if (!trimmed)
        return new Uint8Array(0);
    switch (format) {
...
export function encodeFromBytes(bytes, format, extraOptions) {
    if (bytes.length === 0)
        return "";
    switch (format) {
        case "utf8":
...
export function floatToIEEE754(num, doublePrecision = false) {
...
export function ieee754ToFloat(visual, doublePrecision = false) {
