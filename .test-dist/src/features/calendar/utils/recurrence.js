import { addDays, addWeeks, addMonths, addYears, parseISO, isAfter, differenceInMinutes } from 'date-fns';
/**
 ...
 */
export function getExpandedEvents(events, rangeStart, rangeEnd) {
    const expanded = [];
    ...
    normalAndSeries.forEach(event => {
        ...
        while (iterations < maxIterations) {
            ...
            if (seriesEndDate && isAfter(currentStart, seriesEndDate))
                break;
            ...
            if (!isExcepted) {
                ...
                const fallsInRange = (currentStart >= rangeStart && currentStart <= rangeEnd) ||
