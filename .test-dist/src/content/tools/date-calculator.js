export const dateCalculator = {
    detailedDescription: "Add or subtract days, weeks, months, or years from a given date, or calculate the exact difference between two dates in multiple units. Handles daylight saving transitions and leap years correctly. Useful for deadline calculations, project planning, and scheduling.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "Yes. JavaScript's Date object, which powers the tool, handles leap years and varying month lengths automatically.",
        },
        {
            question: "Can I add business days only (excluding weekends)?",
            answer: "Yes, if the tool has a 'business days' mode. Enable it to skip Saturdays and Sundays when adding or subtracting days.",
        },
        {
            question: "Are public holidays excluded?",
            answer: "Public holidays are not excluded by default as they vary by country. Use the business-days mode for weekend exclusion only.",
        },
    ],
    useCases: [
