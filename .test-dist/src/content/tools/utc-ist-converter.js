export const utcIstConverter = {
    detailedDescription: "Quickly and deterministically convert between Coordinated Universal Time (UTC) and Indian Standard Time (IST, UTC+5:30). Supports interactive single conversions, 12/24-hour modes, second/millisecond precision, Unix timestamps, ISO 8601 strings, batch conversions, CSV/JSON exports, and date rollover detection. Works 100% offline in your browser.",
    howTo: [
