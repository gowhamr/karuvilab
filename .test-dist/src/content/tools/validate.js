export const fileValidator = {
    detailedDescription: "Validate files against specific requirements before uploading them to government portals or applications. Check file size (KB/MB), dimensions (pixels), and MIME types instantly. The tool alerts you to common security issues and format mismatches. No files are uploaded.",
    howTo: [
