export const taskReminder = {
    detailedDescription: "A lightweight to-do list manager that stores tasks in your browser's `localStorage` so they persist across page reloads — no account or server required. Add tasks with optional due dates, mark them complete, and delete them when done. Data stays on your device.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "Tasks are saved in your browser's `localStorage`. They persist as long as you don't clear your browser data.",
        },
        {
            question: "Can I sync tasks across devices?",
            answer: "No. `localStorage` is device- and browser-specific. For cross-device sync, use a dedicated app like Todoist or Notion.",
        },
        {
            question: "What happens if I clear my browser data?",
            answer: "Clearing cookies and site data will erase your tasks. Export them before clearing if you want to keep them.",
        },
    ],
    useCases: [
