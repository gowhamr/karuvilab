export const compoundInterest = {
    detailedDescription: "Calculate the future value of an investment using the compound interest formula. Supports different compounding frequencies (daily, monthly, quarterly, annually) and an optional regular contribution. Shows a year-by-year growth chart and breakdown. All calculations run locally.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "A = P × (1 + r/n)^(n×t), where P = principal, r = annual rate, n = compounding periods per year, t = years.",
        },
        {
            question: "What compounding frequency is best?",
            answer: "More frequent compounding yields slightly higher returns. Daily compounding gives marginally more than annual, but the difference diminishes with lower rates.",
        },
        {
            question: "How does a regular contribution affect the result?",
            answer: "Regular contributions are compounded from the time they are added, significantly boosting long-term growth — this is the core principle behind SIP investing.",
        },
    ],
    useCases: [
