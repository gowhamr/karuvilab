export const slugGenerator = {
    detailedDescription: "Convert any page title or phrase into a clean, SEO-friendly URL slug. Removes special characters, converts spaces to hyphens, lowercases everything, and strips common stop words optionally. Generates slugs instantly in the browser — no server required.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "Google treats hyphens as word separators and underscores as word joiners. Use hyphens for SEO-friendly URLs.",
        },
        {
            question: "What characters are removed?",
            answer: "All characters that are not alphanumeric or hyphens are removed. Accented characters (é, ñ, ü) are transliterated to ASCII equivalents.",
        },
        {
            question: "Should I include stop words in the slug?",
            answer: "Short, descriptive slugs are preferred. Removing stop words (the, is, of) makes slugs shorter and cleaner without losing keyword value.",
        },
    ],
    useCases: [
