export const imageConverter = {
    detailedDescription: "Convert images between JPEG, PNG, WebP, and BMP formats using the browser's Canvas API. Simply upload an image, choose the output format, and download the converted file. No file is ever sent to a server — conversion is entirely local.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "Yes. JPEG is a lossy format. Each re-encoding introduces some quality loss. Use the quality slider to balance size and fidelity.",
        },
        {
            question: "Can I convert a WebP image to JPEG?",
            answer: "Yes. The tool handles WebP input natively in modern browsers (Chrome, Edge, Firefox).",
        },
        {
            question: "Does Safari support WebP?",
            answer: "Safari 14+ supports WebP. If you need compatibility with older Safari versions, convert to PNG or JPEG instead.",
        },
    ],
    useCases: [
