export const format = {
    detailedDescription: "A multi-language code formatter supporting JSON, HTML, CSS, SQL, and Markdown. Paste messy code and get properly indented, consistently styled output in one click using Prettier-compatible formatting rules. No code is sent to a server — formatting runs entirely in the browser.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "The tool uses Prettier (for JS/HTML/CSS/Markdown) and sql-formatter for SQL, compiled to WebAssembly so everything runs in the browser.",
        },
        {
            question: "Can I configure the indentation width?",
            answer: "Yes. Use the settings panel to set indent size (2 or 4 spaces, or tabs) and other style options.",
        },
        {
            question: "Does it support JSX or TypeScript?",
            answer: "TypeScript and JSX formatting may be available under the 'JS/TS' tab. Check the language selector for the full list.",
        },
    ],
    useCases: [
