export const ogPreview = {
    detailedDescription: "Simulate how a URL's Open Graph (og:) meta tags will appear when shared on Facebook, Twitter, LinkedIn, and WhatsApp. Enter a URL or paste og: tags directly to see the social media card preview. All rendering is done in the browser — the tool fetches the URL via a proxy or reads pasted tags.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "Social platforms cache og: data. After updating tags, use the platform's own debugging tool (e.g., Facebook Sharing Debugger) to force a cache refresh.",
        },
        {
            question: "What image size does Facebook recommend?",
            answer: "Facebook recommends 1200×630 pixels for the best display across desktop and mobile.",
        },
        {
            question: "What is the og:type tag?",
            answer: "`og:type` describes the content type (e.g., `website`, `article`, `product`). The correct type affects how the card is rendered on some platforms.",
        },
    ],
    useCases: [
