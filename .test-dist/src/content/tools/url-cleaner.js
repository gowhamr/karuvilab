export const urlCleaner = {
    detailedDescription: "Strip UTM parameters, ad tracking tokens, and other query string clutter from URLs to produce a clean, shareable link. Supports common tracking parameters from Google Analytics, Facebook Ads, MailChimp, and more. Runs entirely in the browser — no URLs are sent to a server.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "By default: `utm_source`, `utm_medium`, `utm_campaign`, `utm_term`, `utm_content`, `fbclid`, `gclid`, `mc_eid`, `ref`, `source`, and dozens more. You can customise the list.",
        },
        {
            question: "Will removing UTM parameters break the destination page?",
            answer: "No. UTM parameters are only used for analytics tracking. The destination page content is the same with or without them.",
        },
        {
            question: "Can I keep certain parameters?",
            answer: "Yes. Use the exclusion list to specify parameters that should not be removed (e.g., a `?id=` that the page actually needs).",
        },
    ],
    useCases: [
