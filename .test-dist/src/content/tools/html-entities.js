export const htmlEntities = {
    detailedDescription: "Convert special HTML characters to their named or numeric entity equivalents (e.g., `<` → `&lt;`) and decode entities back to readable characters. Essential for safely embedding user-generated content in HTML without triggering XSS vulnerabilities. Runs entirely in the browser.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "Characters like `<`, `>`, `&`, and `\"` have special meaning in HTML. Without encoding them, they can break page structure or enable cross-site scripting (XSS) attacks.",
        },
        {
            question: "What is the difference between named and numeric entities?",
            answer: "`&amp;` is a named entity; `&#38;` is the decimal numeric form; `&#x26;` is the hex form. They all produce the same character — `&`.",
        },
        {
            question: "Does this handle all Unicode characters?",
            answer: "Most Unicode characters do not need encoding in modern UTF-8 HTML. The tool focuses on the characters that must be escaped for safety: `<`, `>`, `&`, `\"`, `'`.",
        },
    ],
    useCases: [
