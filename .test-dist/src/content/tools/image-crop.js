export const imageCrop = {
    detailedDescription: "Crop images interactively with freeform selection or locked aspect ratios (1:1, 4:3, 16:9, etc.) using a drag-and-drop crop interface. Preview the crop before applying and download the result. All cropping is done in your browser using Canvas — no upload needed.",
    howTo: [
    ...
    faq: [
        {
            ...
            answer: "Yes. Enter exact pixel values for width and height in the crop settings to define a precise crop region.",
        },
        {
            question: "Does cropping reduce file size?",
            answer: "Yes, significantly. A smaller canvas contains fewer pixels and therefore produces a smaller file on export.",
        },
        {
            question: "Can I undo a crop?",
            answer: "The original image remains loaded. Simply adjust the crop handles and re-apply without re-uploading.",
        },
    ],
    useCases: [
