export const tiffConverter = {
    detailedDescription: "Convert images to and from the professional TIFF format directly in your browser. Upload TIFF files to export as web-friendly PNG, JPEG, or WebP formats, or upload standard images to encode them into high-fidelity TIFF format. Processed 100% locally with zero server uploads.",
    howTo: [
