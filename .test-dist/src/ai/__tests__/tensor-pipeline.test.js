...
import { createFloat32Tensor, normalizePixels, applySigmoid, applySoftmax, findArgmax, generateTiles } from '../pipeline';
import { ai } from '../sdk';
describe('AI Platform v1.0 - Generic Tensor Pipeline', () => {
    ...
    it('should ensure model availability via high-level SDK ai.ensureModel()', async () => {
        const { AI_MODEL_REGISTRY } = await import('../registry');
