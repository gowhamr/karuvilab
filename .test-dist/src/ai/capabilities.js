...
export async function detectCapabilities() {
    ...
    const webgpu = !isServer && 'gpu' in navigator && typeof navigator.gpu?.requestAdapter === 'function';
