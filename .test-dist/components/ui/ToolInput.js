...
export function ToolInput({ label, value, onChange, placeholder, rows = 1, type = "text", inputMode, autoComplete, description, error, mono = false, id: providedId, readOnly, className, loading, style, step }) {
