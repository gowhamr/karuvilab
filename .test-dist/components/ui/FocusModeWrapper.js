...
export function FocusModeWrapper({ toolId, toolName, children, showTrigger = true, triggerPosition = 'top-right', }) {
    ...
    return (_jsxs("div", { ref: overlayRef, role: isThisToolFullscreen ? "dialog" : undefined, "aria-modal": isThisToolFullscreen ? "true" : undefined, "aria-label": isThisToolFullscreen ? `${toolName} — Focus Mode` : undefined, className: isThisToolFullscreen
            ? "fixed inset-0 z-modal bg-bg flex flex-col h-screen w-screen overflow-hidden"
            : "relative group/focus", children: [!isThisToolFullscreen && showTrigger && (_jsxs("div", { className: `
            absolute z-content
        ...
        `, children: [_jsxs("button", { onClick: () => enterFocus(toolId), "aria-label": "Enter focus mode (f)", title: "Focus mode (f)", className: "flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-surface-2/80 backdrop-blur-sm border border-border text-text-3 hover:text-text hover:bg-surface text-xs font-medium cursor-pointer", children: [_jsx("span", { className: "hidden sm:inline", children: "Focus" }), !isMobile && (_jsx("kbd", { className: "hidden md:inline text-tiny px-1 py-0.5 bg-surface border border-border rounded font-mono", children: "F" }))] }), _jsxs("button", { onClick: () => enterDashboard(toolId), "aria-label": "Enter dashboard mode (F11)", title: "Dashboard mode (F11)", className: "flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-surface-2/80 backdrop-blur-sm border border-border text-text-3 hover:text-text hover:bg-surface text-xs font-medium cursor-pointer", children: [_jsx(Maximize2, { className: "w-3.5 h-3.5" }), _jsx("span", { className: "hidden sm:inline", children: "Dashboard" }), !isMobile && (_jsx("kbd", { className: "hidden md:inline text-tiny px-1 py-0.5 bg-surface border border-border rounded font-mono", children: "F11" }))] })] })), isThisToolFullscreen && !isDashboard && (_jsx(FocusModeToolbar, { toolId: toolId, toolName: toolName, wordCount: wordCount, charCount: charCount, lineCount: lineCount, language: language, onFontSizeChange: onFontSizeChange, onWrapToggle: onWrapToggle })), isDashboard && (_jsxs("button", { onClick: exit, "aria-label": "Exit dashboard mode (Esc or F11)", title: "Exit fullscreen (Esc or F11)", className: "fixed top-3 right-3 z-dropdown flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-surface-2/80 backdrop-blur-sm border border-border text-text-3 hover:text-text hover:bg-surface text-xs font-medium shadow-md opacity-70 hover:opacity-100 transition-all cursor-pointer", children: [_jsx(Maximize2, { className: "w-3.5 h-3.5 rotate-180" }), _jsx("span", { className: "hidden sm:inline", children: "Exit Fullscreen" }), !isMobile && (_jsx("kbd", { className: "hidden md:inline text-tiny px-1 py-0.5 bg-surface border border-border rounded font-mono", children: "Esc" }))] })), _jsx("div", { className: isThisToolFullscreen
