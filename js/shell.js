  ...
  const shell = {
    ...
    render() {
      ...
      header.innerHTML = `
        <div class="ts-brand">
          ...
          <nav class="ts-desktop-nav" aria-label="Main navigation">
            ...
            <a href="${base2}pages/donate.html" class="ts-nav-link ${active === "donate" ? "active" : ""}" style="color: #ec4899; font-weight: 700;">Donate</a>
          </nav>
        </div>
      ...
      dock.innerHTML = `
        ...
        <a href="${base2}pages/donate.html" class="dock-btn ${active === "donate" ? "active" : ""}">
          <svg class="dock-icon" style="color:#ec4899" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.03 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l8.78-8.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
          <span class="dock-lbl" style="color:#ec4899; font-weight:700">Donate</span>
        </a>
      `;
