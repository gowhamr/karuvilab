  ...
  const shell = {
    ...
    render() {
      ...
      dock.innerHTML = `
        ...
        <a href="${base2}pages/help.html" class="dock-btn ${active === "help" ? "active" : ""}"${active === "help" ? ' aria-current="page"' : ""}>
        ...
        <a href="${base2}pages/settings.html" class="dock-btn ${active === "settings" ? "active" : ""}"${active === "settings" ? ' aria-current="page"' : ""}>
    ...
    buildSidebar(base2, active) {
      ...
      aside.innerHTML = `
        <div class="sidebar-head">
          <a href="${base2}" class="sidebar-brand">
        ...
        <nav class="sidebar-scroll">
          <div class="sidebar-group">
            ...
            <div class="sidebar-item">
              <a href="${base2}" class="sidebar-link ${active === "home" ? "active" : ""}">
        ...
        return `
                <div class="sidebar-section">
                  ...
                  <ul class="sidebar-sub-list" id="sb-sub-${g.id}">
                    ${g.items.map((it) => `
                      <li><a href="${base2}${it.href}" class="sidebar-sub-link ${isActive(it.href) ? "active" : ""}">${it.name}</a></li>
                    `).join("")}
                  </ul>
                </div>
              `;
          ...
          <div class="sidebar-group">
            ...
            <div class="sidebar-item">
              <a href="${base2}pages/help.html" class="sidebar-link ${active === "help" ? "active" : ""}">
                <span class="sidebar-icon">${ICON.help}</span>
                <span class="sidebar-link-text">Help & FAQ</span>
              </a>
            </div>
            <div class="sidebar-item">
              <a href="${base2}pages/settings.html" class="sidebar-link ${active === "settings" ? "active" : ""}">
