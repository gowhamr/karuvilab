...
export default function RotatePdf() {
  ...
  return (
    <>
      <Script src="https://unpkg.com/pdf-lib@1.17.1/dist/pdf-lib.min.js" onLoad={() => { setLibReady(true); if (file) loadFile(file); }} />
      <ToolShell title="Rotate PDF" description="Rotate one or all pages of a PDF by 90°, 180°, or 270°." category={cat}>
