...
export default function PdfToWord() {
  ...
  return (
    <>
      ...
      <ToolShell title="PDF to Word" description="Extract text from PDF files. Full Word conversion requires server-side processing; this tool outputs plain text." category={cat}>
