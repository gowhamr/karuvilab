...
export const metadata: Metadata = { title: "404 — KaruviLab" };
...
export default function NotFound() {
  return (
    <div className="max-w-2xl mx-auto py-24 text-center space-y-6">
      ...
      <Link href="/" className="inline-block px-6 py-3 bg-blue text-white font-bold rounded-xl hover:scale-[1.02] transition-all">
        Back to all tools
      </Link>
    </div>
  );
