...
const PRESETS = [
  ...
  { name: 'Glow Blue', layers: [{ id: '1', offsetX: 0, offsetY: 0,  blur: 20, spread: 0,  color: '#4F46E5', opacity: 40, inset: false }] },
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      ...
      >
        ...
        <div className="absolute top-4 left-4 flex gap-4 bg-white/80 dark:bg-black/50 backdrop-blur-md p-2 rounded-2xl border border-border/50 shadow-sm z-10">
           <div className="flex items-center gap-2">
             ...
             <span className="text-[10px] font-black uppercase tracking-widest text-text-4">BG</span>
           </div>
           <div className="flex items-center gap-2 border-l border-border/50 pl-4">
             ...
             <span className="text-[10px] font-black uppercase tracking-widest text-text-4">Box</span>
           </div>
        </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-text-4 flex justify-between">X <span>{layer.offsetX}px</span></label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-text-4 flex justify-between">Y <span>{layer.offsetY}px</span></label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-text-4 flex justify-between">Blur <span>{layer.blur}px</span></label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-text-4 flex justify-between">Spread <span>{layer.spread}px</span></label>
                  ...
                  <div className="flex items-center gap-6 pt-2">
                    ...
                    <div className="flex-1 space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-text-4 flex justify-between">Opacity <span>{layer.opacity}%</span></label>
