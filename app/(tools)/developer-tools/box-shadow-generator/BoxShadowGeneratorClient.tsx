      ...
      >
        ...
        <div className="absolute top-4 left-4 flex gap-4 bg-surface/80 backdrop-blur-md p-2 rounded-2xl border border-border/50 shadow-sm z-10">
           <div className="flex items-center gap-2">
             ...
             <span className="text-xs font-black uppercase tracking-widest text-text-4">BG</span>
           </div>
           <div className="flex items-center gap-2 border-l border-border/50 pl-4">
             ...
             <span className="text-xs font-black uppercase tracking-widest text-text-4">Box</span>
           </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-surface border border-border rounded-4xl p-6 shadow-sm space-y-6">
             <h3 className="text-xs font-black uppercase tracking-[0.2em] text-text-4">Box Properties</h3>
             <div className="space-y-2">
