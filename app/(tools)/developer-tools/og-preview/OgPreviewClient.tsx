      ...
      output={
        <div className="flex flex-col h-full space-y-8">
          ...
          <div className="space-y-3">
            <h2 className="text-sm font-bold text-text-2">Google Search</h2>
          ...
          {/* Facebook / OG */}
          <div className="space-y-3">
            <h2 className="text-sm font-bold text-text-2">Facebook / Open Graph</h2>
          ...
          {/* Twitter */}
          <div className="space-y-3">
            <h2 className="text-sm font-bold text-text-2">Twitter / X Card</h2>
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-border overflow-hidden max-w-lg shadow-sm">
