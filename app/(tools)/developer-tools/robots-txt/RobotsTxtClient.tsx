    ...
    <ToolWorkspace
      input={
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-text-2 uppercase tracking-wider">Rule Sets</h2>
            <button onClick={addRule} className="text-xs font-medium text-blue hover:text-blue/80 transition-colors">
              + Add Rule Set
            </button>
          </div>
          <div className="space-y-4">
            {rules.map((rule, idx) => (
              <div key={rule.id} className="bg-bg border border-border p-5 rounded-2xl shadow-sm space-y-3 relative">
                <div className="flex items-center justify-between">
      ...
      optionsPanel={
        <div className="space-y-3">
          <h2 className="text-sm font-bold text-text-2 uppercase tracking-wider">Sitemap URL</h2>
