...
export default function SalaryCalculatorClient() {
  ...
  return (
    <ToolWorkspace
      ...
      input={
        <ToolInput
          label={`Annual CTC (${inr(parseFloat(ctc) || 0)})`}
          type="number"
      ...
      output={
        <div className="space-y-6">
          ...
          <div className="bg-bg border border-border rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {result.slabs.map((s) => (
                    <tr key={s.range} className="border-b border-border/50 hover:bg-surface transition-colors">
          ...
          <div className="bg-bg border border-border p-4 rounded-xl flex flex-col sm:flex-row gap-4 items-center justify-between">
