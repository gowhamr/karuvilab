          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-bg/50 border-b border-border">
                ...
                <th className="px-4 py-3 text-right font-black uppercase text-[10px] tracking-wider text-text-4">Total Withdrawn</th>
                <th className="px-4 py-3 text-right font-black uppercase text-[10px] tracking-wider text-text-4">Remaining Balance</th>
              </tr>
            </thead>
            <tbody>
              {result.rows.map((row) => (
