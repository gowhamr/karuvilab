                ...
                <div className="grid grid-cols-2 gap-2">
                  {(["add", "subtract"] as const).map((op) => (
                    <button
                      ...
                      onClick={() => setAddOp(op)}
                      className={cn(
                        "flex items-center justify-center gap-2 py-3 rounded-xl text-tiny font-bold uppercase tracking-widest-sm border transition-all",
                        addOp === op
                ...
                {(["days", "months", "years"] as const).map((u) => (
                  <button
                    ...
                    className={cn(
                      ...
                      addUnit === u ? "bg-surface text-blue shadow-sm" : "text-text-muted hover:text-text"
                    )}
                  >
                    {u}
                  </button>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 border-b border-border pb-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-text-muted uppercase">Calculated arrival</p>
                </div>
              </div>
