        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-surface border border-border rounded-4xl p-6 sm:p-8 shadow-sm space-y-6 relative overflow-hidden">
            ...
            <div className="text-center border-b border-border/50 pb-8">
              <p className="text-[10px] font-black uppercase tracking-widest text-text-4 mb-2">Total Estimated Corpus</p>
            ...
            <div className="grid grid-cols-2 gap-8 pt-4">
               <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-text-4 mb-1">Total Invested</p>
                  <span className="text-xl font-bold text-text-2">{formatCurrency(result.totalInvested)}</span>
               </div>
               <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-text-4 mb-1">Wealth Gained</p>
