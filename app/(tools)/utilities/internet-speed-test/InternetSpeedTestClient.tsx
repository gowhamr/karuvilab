...
export default function InternetSpeedTestClient() {
  ...
  return (
    <ToolWorkspace
      layout="stacked"
      input={
        <div className="relative space-y-12 pt-4">
          <div className="absolute -top-4 sm:-top-6 -left-4 sm:-left-6 w-[calc(100%+2rem)] sm:w-[calc(100%+3rem)] h-1 bg-gradient-to-r from-blue via-indigo-500 to-purple-500 opacity-20" />
