...
export default function ImageFlipClient() {
  ...
  const inputContent = originalUrl ? (
  ...
  const optionsContent = originalUrl ? (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-border">
        <div className="text-xs text-text-muted font-medium flex items-center gap-2">
          ...
          {dimensions && (
            <span className="bg-bg px-2 py-0.5 rounded-md border border-border text-[11px] whitespace-nowrap">
  ...
  const outputContent = originalUrl ? (
    <div className="space-y-4 flex flex-col h-full">
      <div className="flex items-center justify-between">
      ...
      <AnimatePresence>
        {errorMsg && (
          <m.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="flex items-center gap-3 p-4 bg-error/10 border border-error/20 rounded-2xl text-error text-xs font-semibold max-w-2xl mx-auto"
          >
