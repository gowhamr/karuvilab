...
export default function AdvancedRotateClient() {
  ...
  return (
    <ToolWorkspace
      layout={!originalUrl ? "stacked" : "split"}
      infoPanel={
      ...
      output={
        originalUrl ? (
          <div className="flex flex-col h-full min-h-[400px] justify-between gap-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="w-full py-4 bg-blue text-white font-bold rounded-xl hover:opacity-95 active:scale-98 transition-all flex items-center justify-center gap-2 shadow-md disabled:opacity-40 disabled:cursor-not-allowed disabled:scale-100 mt-auto"
            >
