...
import { 
  ...
  Cpu, HardDrive, Info, Check, Eye, HelpCircle, AlertCircle, EyeOff, Sliders, BookOpen
} from "lucide-react";
...
export default function ToolClient() {
  ...
  return (
    <>
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 bg-surface border border-border rounded-3xl mb-8">
