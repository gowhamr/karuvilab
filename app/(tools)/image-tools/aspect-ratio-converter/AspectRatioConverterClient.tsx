        ...
        <ToolWorkspace
          ...
          output={
            <div className="flex flex-col h-full">
              ...
              {origDimensions && (
                <div className="grid grid-cols-2 gap-3 p-3 bg-bg border border-border rounded-xl text-xs mt-4">
                  <div>
              ...
              <div className="relative flex-1 min-h-[320px] max-h-[520px] bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] dark:bg-[radial-gradient(#1e293b_1px,transparent_1px)] [background-size:16px_16px] rounded-xl border border-border p-4 flex items-center justify-center overflow-hidden mt-4">
                {isProcessing && (
