      ...
      <div className="mt-16 space-y-6 max-w-4xl mx-auto w-full">
        ...
        >
          <div className="prose prose-sm md:prose-base dark:prose-invert max-w-none">
            ...
            <p>
              To extract "Even Pages" (Page 2, 4, 6...), the algorithm iterates over the PDF's internal <code>/Kids</code> array and selects pages where the index is an odd number (index 1, 3, 5...). The mathematical logic uses the modulo operator: <code>index % 2 !== 0</code>.
            </p>
          </div>
        </ToolInfoSection>
