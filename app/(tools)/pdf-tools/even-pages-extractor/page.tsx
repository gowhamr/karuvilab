    ...
    >
      ...
      <LearningHub title="Understanding Array Mathematics">
        ...
        <LearningSection type="algorithm" title="The Modulo Operator">
          <p>To extract "Even Pages" (Page 2, 4, 6, 8...), the algorithm must iterate over the PDF's internal <code>/Kids</code> array and select the pages located at odd indices (index 1, 3, 5, 7...).</p>
        ...
        <LearningSection type="general" title="Check Your Knowledge" fullWidth>
          <QuizWidget 
            questions={[
              {
                question: "In a zero-indexed array, what is the index of Page 10?",
                options: [
                  "10",
                  "9",
                  "11",
