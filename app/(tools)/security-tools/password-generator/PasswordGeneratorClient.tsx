          ...
          {passwords.length > 0 ? (
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                ...
                <div className={cn(
                  "p-5 rounded-3xl space-y-3 border transition-colors sm:col-span-2 xl:col-span-1",
            ...
            <m.div 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="h-full flex flex-col items-center justify-center text-text-muted space-y-4 p-8 min-h-[400px]"
            >
              <Key className="w-12 h-12 opacity-20" />
              <p className="text-sm font-medium">Generated passwords will appear here</p>
            </m.div>
          )}
        </AnimatePresence>
      }
      infoPanel={
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-6">
            ...
            <div className="bg-surface border border-border rounded-4xl p-4 sm:p-6 shadow-sm h-full">
          ...
          {history.length > 0 && (
            <div className="space-y-6">
              <h2 className="text-tiny font-bold uppercase tracking-widest-sm-lg text-text-muted px-2 flex items-center gap-2">
                <History className="w-3.5 h-3.5" />
                Recent History
              </h2>
              <div className="bg-surface border border-border rounded-4xl p-4 sm:p-6 shadow-sm">
