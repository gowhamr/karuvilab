      ...
      input={
        <div className="space-y-4">
          <ToolInput
            ...
            label="Paste Private Key (PKCS#8 or PKCS#1 PEM):"
        ...
        <div className="flex flex-col h-full space-y-4">
          ...
          {info && (
            <div className="p-5 rounded-xl bg-surface-2 border border-border space-y-4 flex-1">
              ...
              <div className="p-3 rounded-lg bg-bg border border-border space-y-1">
          ...
          {!error && !info && (
            <div className="flex-1 flex items-center justify-center text-text-4 italic min-h-[200px]">
